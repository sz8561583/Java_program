...
public class Main {
    public static void main(String[] args) {
        ...
        while (n-- > 0) {
            ...
            switch (op[0]) {
                case "summon" -> summon(ATK, Integer.parseInt(op[1]), Integer.parseInt(op[2]), Integer.parseInt(op[3]));
                case "attack" -> attack(ATK, DEF, Integer.parseInt(op[1]), Integer.parseInt(op[2]));
                case "end" -> {
                    ATK.turn = false;
                    DEF.turn = true;
                }
